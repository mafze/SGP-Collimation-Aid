Public Class HSVColorClass
	...
	End Function
	Public Shared Function HighContrastRGB(ByVal n As Integer) As RGB
		Select Case n
			Case 0
				Return New RGB(CByte(0), CByte(0), CByte(255))
			Case 1
				Return New RGB(CByte(0), CByte(255), CByte(0))
			Case 2
				Return New RGB(CByte(255), CByte(0), CByte(0))
			Case 3
				Return New RGB(CByte(0), CByte(255), CByte(255))
			Case 4
				Return New RGB(CByte(255), CByte(0), CByte(255))
			Case 5
				Return New RGB(CByte(255), CByte(255), CByte(0))
		End Select
	End Function
